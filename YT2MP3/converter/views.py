...
def videodetails(request):
    ...
    return JsonResponse({'vtitle':myVideo.title,'vlength':str(myVideo.length),'vthumburl':myVideo.thumbnail_url,'vdesc':myVideo.description,'vviews':str(myVideo.views),'vage':str(myVideo.age_restricted),'vvid':str(myVideo.video_id)})